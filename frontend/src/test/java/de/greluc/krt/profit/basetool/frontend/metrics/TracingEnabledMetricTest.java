...
/**
 * Tests for {@link TracingEnabledMetric}, chiefly that the gauge is present and reports zero when
 * tracing is off, so it is distinguishable from an unscraped module.
 */
