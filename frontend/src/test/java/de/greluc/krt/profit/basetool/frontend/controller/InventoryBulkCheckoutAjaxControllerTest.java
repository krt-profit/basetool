...
/**
 * MVC tests for the bulk-checkout proxy {@link InventoryWriteController#bulkCheckout}: success
 * answers {@code 204}, a backend lock conflict is relayed as {@code problem+json} with its {@code
 * code}, and an empty id list is rejected with {@code 422} without a backend call.
 */
@SpringBootTest
