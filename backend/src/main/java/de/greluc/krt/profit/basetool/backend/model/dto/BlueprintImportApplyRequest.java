...
/**
 * Write payload for applying a blueprint import: the user's per-name resolutions in one batch.
 * Blank product keys are skipped; manual choices are recorded as aliases.
 *
