...
/**
 * One game-item inventory entry earmarked to a job order, for the order-detail Item-Bestand panel
 * (REQ-ORDERS-028).
 *
 * @param inventoryEntryId the inventory entry's primary key
 * @param version the entry's {@code @Version} (0 when still {@code null})
 ...
 * @param allocatedQuantity the whole-unit slice earmarked to this order, at most {@code quantity}
