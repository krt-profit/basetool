...
public class City extends AbstractEntity<UUID> {
  ...
  /**
   * Whether a live refinery terminal exists at this city, recomputed by {@code
   * UexUniverseSyncService.reconcileRefineryTerminalFlags()} (REQ-REFINERY-020). This, not the raw
   * UEX claim in {@link #hasRefinery}, is what the refinery-order picker and its gates use.
   */
