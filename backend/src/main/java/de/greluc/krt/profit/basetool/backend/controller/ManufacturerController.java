...
/**
 * Read-mostly REST surface over the manufacturer catalog plus the admin-only {@code hidden} toggle;
 * the catalog itself is maintained by {@code UexManufacturerService}.
 *
