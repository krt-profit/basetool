 ...
 * (REQ-OBS-005): with blank scrape credentials every request is denied. The blank values are set as
 * test properties so exported {@code MONITORING_SCRAPE_*} variables cannot leak in.
 */
