...
/** Unit tests for the scheduled rejected-registration retention sweep (REQ-SEC-057). */
@ExtendWith(MockitoExtension.class)
class RejectedRegistrationRetentionTaskTest {
  ...
  void purgesRegistrationsRejectedBeforeTheCutoff() {
    ...
    verify(retentionService).purgeRejectedOlderThan(cutoff.capture());
