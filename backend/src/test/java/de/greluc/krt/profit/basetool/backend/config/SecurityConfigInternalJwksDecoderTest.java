...
/**
 * Asserts the opt-in internal-JWKS decoder accepts every asymmetric JWS algorithm, not only RS256
 * (REQ-SEC-024), by decoding an ES256 token against an EC JWKS.
 */
