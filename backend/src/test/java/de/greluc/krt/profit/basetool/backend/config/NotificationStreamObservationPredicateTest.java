...
/**
 * Unit tests for the SSE-stream observation exclusion (REQ-OBS-009): the ~30-minute notification
 * stream endpoint is dropped from {@code http.server.requests} so its lifetime never pollutes the
