...
- **Public sign-up surface** — unauthenticated visitors can sign up for non-internal missions as a named guest. Raising a job order used to be part of this and no longer is: it requires an account (ADR-0149).
