> **Archived 2026-09-22.** Doc type: Historical plan — frozen, kept as a record and no longer updated. v1 shipped on 2026-06-10. Phases 4 and 5 were deferred by owner decision and are governed by their GitHub issues.
>
> **Current truth:** [`refinery-screenshot-import.md`](../specs/refinery-screenshot-import.md), [ADR-0007](../adr/0007-client-side-vlm-screenshot-extraction.md), [ADR-0008](../adr/0008-refinery-extract-json-contract.md). Index of the archive: [`README.md`](README.md).
