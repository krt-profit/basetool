...
| #  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             Work package                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|----|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| E1 | **The decisive experiment, and a first — not a repeat.** On the isolated test stack, create the refresh-only DPoP client policy and confirm for `basetool-android` that the access token is issued **without** `cnf` (the backend accepts it as a plain Bearer), the refresh token is bound, and a refresh replayed with a different key fails. There is **no working precedent** for this in the realm: production carries zero client profiles and zero policies (verified 2026-08-17), and the extractor deliberately needs none — since ADR-0129 it *wants* both tokens bound, because the gateway validates the proof at the hop that consumes it. The app is the opposite case: it talks to the backend directly, and Spring Security's bearer filter rejects a `cnf`-bound access token outright. The entire token posture depends on this experiment; if it fails, the fallback ladder (backend `.dPoP()` support, or plain PKCE as an approved deviation) changes the app's networking layer |
