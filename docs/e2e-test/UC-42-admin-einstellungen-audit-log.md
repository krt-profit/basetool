...
| **ID**         | UC-42                                                                                                                                                                                                                                                                                                                                                        |
| **Tag**        | `e2e`                                                                                                                                                                                                                                                                                                                                                        |
| **Testklasse** | [`AdminSettingsInPlaceE2eTest`](../../frontend/src/e2e/java/de/greluc/krt/profit/basetool/frontend/e2e/AdminSettingsInPlaceE2eTest.java) · [`AuditLogE2eTest`](../../frontend/src/e2e/java/de/greluc/krt/profit/basetool/frontend/e2e/AuditLogE2eTest.java) · [`AdminPagesSmokeE2eTest`](../../frontend/src/e2e/java/de/greluc/krt/profit/basetool/frontend/e2e/AdminPagesSmokeE2eTest.java) |
...
`test-admin` (ADMIN). Alle drei Klassen betreffen ADMIN-only-Seiten.
