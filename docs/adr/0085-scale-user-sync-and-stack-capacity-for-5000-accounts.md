...
- **Status:** Accepted — its Redis ceiling (`maxmemory 384mb` / 512 MB) rises to 768 MB / 1024 MB by [ADR-0221](0221-redis-grows-to-768-mb-and-holds-a-bounded-exchange-partition.md) (epic #2078)
- **Date:** 2026-07-09
- **Deciders:** @greluc
