...
> README's live-sync line points here (see [`README.md`](../README.md)). Requirements: REQ-FE-015 and [ADR-0092](adr/0092-tool-wide-topic-room-live-sync-relay.md). The Redis fan-out infra lands in the self-contained commit `5e648cf4` ("fan the SSE push across replicas via Redis pub/sub").
